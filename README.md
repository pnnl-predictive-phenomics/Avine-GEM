...
This is a memote repository for a genome-scale metabolic model of *Azotobacter vinelandii*
[Memote test results for the models](https://pnnl-compbio.github.io/Avine-GEM/)
...
1. **Clone the Repository**
   ```
   git clone https://github.com/pnnl-predictive-phenomics/Avine-GEM.git
   cd Avine-GEM
   ```
...
This project is licensed under the [BSD 2-clause](https://github.com/pnnl-predictive-phenomics/Avine-GEM/blob/main/LICENSE) license. See the `LICENSE` file for details.
