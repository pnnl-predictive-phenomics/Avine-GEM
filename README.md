...
This project is licensed under the [Apache 2.0](https://github.com/pnnl-predictive-phenomics/Avine-GEM/blob/main/LICENSE) license. See the `LICENSE` file for details.
